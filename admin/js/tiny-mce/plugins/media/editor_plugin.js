      ...
      n.onInit.add(function () {
        ...
        if (n && n.plugins.contextmenu) {
          n.plugins.contextmenu.onContextMenu.add(function (s, t, i) {
            if (
              i.nodeName === "IMG" &&
              i.className.indexOf("mceItemMedia") !== -1
            ) {
    ...
    imgToObject: function (z, o) {
      ...
      function r(i, n) {
        ...
        J = p.getParam(
          ...
          u.convertUrl(u.url + "/moxieplayer.swf")
        );
        if (J) {
          M = p.documentBaseURI;
          G.params.src = J;
