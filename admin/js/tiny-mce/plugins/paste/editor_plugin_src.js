  ...
  tinymce.create("tinymce.plugins.PastePlugin", {
    init: function (ed, url) {
      ...
      ed.onKeyDown.addToTop(function (ed, e) {
        ...
        if (
          ((tinymce.isMac ? e.metaKey : e.ctrlKey) && e.keyCode == 86) ||
        ...
        if (tinymce.isGecko) {
          ...
          if (
            ...
            if (
              ...
              /^(p|h[1-6]|pre)$/i.test(o.node.firstChild.nodeName) &&
          ...
          if (ed.pasteAsPlainText && !cookie.get("tinymcePasteText")) {
            if (getParam(ed, "paste_text_sticky")) {
              ed.windowManager.alert(
                ed.translate("paste.plaintext_mode_sticky")
              );
            } else {
      ...
      function grabContent(e) {
        ...
        if (e.clipboardData || dom.doc.dataTransfer) {
          textContent = (e.clipboardData || dom.doc.dataTransfer).getData(
            "Text"
          );
    ...
    _preProcess: function (pl, o) {
      ...
      if (
        /class="?Mso|style="[^"]*\bmso-|w:WordDocument/i.test(h) ||
        o.wordContent
      ) {
        ...
        if (
          getParam(ed, "paste_retain_style_properties").replace(/^none$/i, "")
            .length == 0
        ) {
          h = h.replace(/<\/?span[^>]*>/gi, "");
        } else {
    ...
    _postProcess: function (pl, o) {
      ...
      if (o.wordContent) {
        ...
        if (
          ...
          each(dom.select("*", o.node), function (el) {
            ...
            else if (el.nodeName == "SPAN" && !el.className)
              dom.remove(el, true);
          });
        }
      }
      ...
      if (
        getParam(ed, "paste_remove_styles") ||
        (getParam(ed, "paste_remove_styles_if_webkit") && tinymce.isWebKit)
      ) {
    ...
    _insertPlainText: function (content) {
      ...
      function process(items) {
        each(items, function (v) {
          if (v.constructor == RegExp) content = content.replace(v, "");
