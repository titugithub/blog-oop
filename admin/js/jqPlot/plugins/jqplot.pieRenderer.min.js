...
(function (e) {
    ...
    if (this.shadow) {
      for (var W = 0, V = z.length; W < V; W++) {
        ...
        this.renderer.drawSlice.call(
          this,
          B,
          this._sliceAngles[W][0],
          this._sliceAngles[W][1],
          ab,
          true
        );
      }
      ...
      if (this.showDataLabels && z[W][2] * 100 >= this.dataLabelThreshold) {
        ...
        var u = e(
          '<div class="jqplot-pie-series jqplot-data-label" style="position:absolute;">' +
            T +
            "</div>"
        ).insertBefore(o.eventCanvas._elem);
  ...
  e.jqplot.PieRenderer.prototype.handleMove = function (q, p, t, s, r) {
    if (s) {
      ...
      if (
        ...
        !(
          o[0] == r.plugins.pieRenderer.highlightedSeriesIndex &&
  ...
  function d(t, r, q) {
    ...
    p.renderer.drawSlice.call(
      p,
      o._ctx,
      p._sliceAngles[q][0],
      p._sliceAngles[q][1],
      p.highlightColorGenerator.get(q),
      false
    );
  }
  function k(q) {
  ...
  function b(s, r, v, u, t) {
    if (u) {
      ...
      if (
        ...
        !(
          q[0] == t.plugins.pieRenderer.highlightedSeriesIndex &&
          q[1] == t.series[q[0]]._highlightedPoint
        )
      ) {
  ...
  function a(r, q, u, t, s) {
    if (t) {
      ...
      if (
        ...
        !(
          p[0] == s.plugins.pieRenderer.highlightedSeriesIndex &&
