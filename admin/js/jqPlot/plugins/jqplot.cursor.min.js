...
(function (j) {
  ...
  j.jqplot.Cursor.prototype.doZoom = function (F, s, B, t) {
    ...
    if (
      (G.constrainZoomTo == "none" &&
        Math.abs(F.x - G._zoom.start[0]) > 6 &&
        Math.abs(F.y - G._zoom.start[1]) > 6) ||
      (G.constrainZoomTo == "x" && Math.abs(F.x - G._zoom.start[0]) > 6) ||
      (G.constrainZoomTo == "y" && Math.abs(F.y - G._zoom.start[1]) > 6)
    ) {
      if (!B.plugins.cursor.zoomProxy) {
        for (var x in s) {
          if (G._zoom.axes[x] == undefined) {
            ...
            G._zoom.axes[x].tickFormatString =
              E[x].tickOptions != null ? E[x].tickOptions.formatString : "";
          }
          if (
            G.constrainZoomTo == "none" ||
            (G.constrainZoomTo == "x" && x.charAt(0) == "x") ||
            (G.constrainZoomTo == "y" && x.charAt(0) == "y")
          ) {
            y = s[x];
            if (y != null) {
              var u, w;
              ...
              if (
                this.looseZoom &&
                (E[x].renderer.constructor === j.jqplot.LinearAxisRenderer ||
                  E[x].renderer.constructor === j.jqplot.DateAxisRenderer)
              ) {
    ...
    if (E.showCursorLegend) {
      ...
      for (var B = 0; B < r.length; B++) {
        ...
        if (A.legend.escapeHtml) {
          ...
          j(r[B]).php(j.jqplot.sprintf(E.cursorLegendFormatString, s, x, w));
        }
      }
    }
    z = null;
  ...
  function n(r, t) {
    ...
    switch (v.tooltipLocation) {
      case "nw":
        var q =
          r.x + t._gridPadding.left - s.outerWidth(true) - v.tooltipOffset;
        var u =
          r.y + t._gridPadding.top - v.tooltipOffset - s.outerHeight(true);
        break;
      case "n":
  ...
  function m(u) {
    ...
    switch (v.tooltipLocation) {
      ...
      case "n":
        var r =
          (s.left + (u._plotDimensions.width - s.right)) / 2 -
          t.outerWidth(true) / 2;
        var q = s.top + v.tooltipOffset;
        t.css("left", r);
        t.css("top", q);
      ...
      case "e":
        var r = s.right + v.tooltipOffset;
        var q =
          (s.top + (u._plotDimensions.height - s.bottom)) / 2 -
  ...
  function f(w, t, q, z, u) {
    ...
    if (v.show) {
      ...
      if (
        ...
        !(
          v._zoom.zooming &&
          v.showTooltipOutsideZoom &&
          !v.constrainOutsideZoom
        )
      ) {
        v._tooltipElem.hide();
      }
  ...
  j.jqplot.CursorLegendRenderer.prototype.constructor =
