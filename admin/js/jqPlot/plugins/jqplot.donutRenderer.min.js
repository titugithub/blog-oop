...
(function (e) {
  ...
  e.jqplot.DonutRenderer.prototype.draw = function (N, V, t, P) {
    ...
    if (this.innerDiameter != null) {
      var M =
        this._numberSeries > 1 && this.index > 0
          ? this._previousSeries[0]._diameter
          : this._diameter;
      this._thickness =
        this.thickness ||
      ...
      this._thickness =
        this.thickness || (v / 2 / (this._numberSeries + 1)) * 0.85;
    }
    ...
    for (var Q = 0; Q < V.length; Q++) {
      ...
      if (this.showDataLabels && V[Q][2] * 100 >= this.dataLabelThreshold) {
        ...
        var n =
          this._innerRadius +
          this._thickness * this.dataLabelPositionFactor +
          this.sliceMargin +
          this.dataLabelNudge;
  ...
  e.jqplot.DonutLegendRenderer.prototype.constructor =
    ...
    if (this.show) {
      ...
      B +=
        this.marginRight != null
          ...
          : "";
      this._elem = e(
        '<table class="jqplot-table-legend" style="' + B + '"></table>'
      );
      var F = false,
        x = false,
        n,
      ...
      if (z.show) {
        ...
        for (E = 0; E < n; E++) {
          if (x) {
            p = e('<tr class="jqplot-table-legend"></tr>').prependTo(
              this._elem
            );
          } else {
  ...
  function g(r, q, o) {
    for (var p = 1; p < this.series.length; p++) {
      if (!this.series[p]._previousSeries.length) {
        for (var n = 0; n < p; n++) {
          if (
            this.series[p].renderer.constructor == e.jqplot.DonutRenderer &&
  ...
  function b(r, q, u, t, s) {
    if (t) {
      ...
      if (
        ...
        !(
          p[0] == s.plugins.donutRenderer.highlightedSeriesIndex &&
          p[1] == s.series[p[0]]._highlightedPoint
        )
      ) {
  ...
  function a(q, p, t, s, r) {
    if (s) {
      ...
      if (
        r.series[o[0]].highlightMouseDown &&
        !(
          o[0] == r.plugins.donutRenderer.highlightedSeriesIndex &&
