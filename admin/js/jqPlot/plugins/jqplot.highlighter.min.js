...
(function (d) {
  ...
  function a(m, o) {
    ...
    i.init();
    i.draw(
      p.gridData[o.pointIndex][0],
      p.gridData[o.pointIndex][1],
  ...
  function g(w, q, m) {
    ...
    if (k.useAxesFormatters) {
      ...
      if (k.tooltipAxes == "both" || k.tooltipAxes == "xy") {
        v =
          d.jqplot.sprintf(k.tooltipFormatString, m.data[0]) +
          k.tooltipSeparator +
          d.jqplot.sprintf(k.tooltipFormatString, m.data[1]);
      } else {
        if (k.tooltipAxes == "yx") {
          v =
            d.jqplot.sprintf(k.tooltipFormatString, m.data[1]) +
    ...
    switch (o[e[k.tooltipLocation]]) {
      ...
      case "n":
        ...
        var n =
          A.y + w._gridPadding.top - k.tooltipOffset - B.outerHeight(true) - t;
        break;
      case "ne":
      ...
      case "w":
        var p =
          A.x + w._gridPadding.left - B.outerWidth(true) - k.tooltipOffset - t;
        var n = A.y + w._gridPadding.top - B.outerHeight(true) / 2;
        break;
      default:
        var p =
  ...
  function f(k, j, n, m, l) {
    ...
    if (h.show) {
      if (m == null && h.isHighlighting) {
        ...
        if (
          m != null &&
          l.series[m.seriesIndex].showHighlight &&
          !h.isHighlighting
        ) {
