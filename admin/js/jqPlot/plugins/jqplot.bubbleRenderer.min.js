...
(function (f) {
  ...
  f.jqplot.BubbleRenderer.prototype.setGridData = function (w) {
    ...
    for (var u = 0; u < this.data.length; u++) {
      if (t[u] != null) {
        this.gridData.push([
          q.call(this._xaxis, t[u][0]),
          m.call(this._yaxis, t[u][1]),
          t[u][2],
        ]);
  ...
  f.jqplot.BubbleRenderer.prototype.draw = function (D, J, n) {
    ...
    for (var G = 0; G < this.radii.length; G++) {
      ...
      this.canvas._elem.append(
        this.bubbleCanvases[C].createElement(J[0], J[1], E)
      );
      ...
      this.bubbleCanvases[C].draw(
        J[2],
        F,
        this.bubbleGradients,
        (this.shadowAngle / 180) * Math.PI
      );
      if (z && this.showLabels) {
        p = f(
          '<div style="position:absolute;" class="jqplot-bubble-label"></div>'
        );
        if (this.escapeHtml) {
          p.text(z);
        } else {
  ...
  f.jqplot.BubbleCanvas.prototype.draw = function (m, s, v, p) {
    ...
    if (v && !f.jqplot.use_excanvas) {
      ...
      var u =
        "rgba(" +
        Math.round(o[0] + 0.8 * (255 - o[0])) +
        ", " +
        Math.round(o[1] + 0.8 * (255 - o[1])) +
        ", " +
        Math.round(o[2] + 0.8 * (255 - o[2])) +
        ", " +
        o[3] +
        ")";
  ...
  f.jqplot.BubbleAxisRenderer.prototype.constructor =
    f.jqplot.BubbleAxisRenderer;
  ...
  function e(p, v, q) {
    ...
    if (z.labels[q]) {
      ...
      p.plugins.bubbleRenderer.highlightLabel.appendTo(
        p.plugins.bubbleRenderer.highlightLabelCanvas
      );
      p.plugins.bubbleRenderer.highlightLabel.addClass(
  ...
  function a(s, p, m, v, r) {
    if (v) {
      ...
      if (
        r.series[q[0]].highlightMouseOver &&
        !(
          q[0] == r.plugins.bubbleRenderer.highlightedSeriesIndex &&
          q[1] == r.series[q[0]]._highlightedPoint
        )
      ) {
  ...
  function b(s, p, m, u, r) {
    if (u) {
      ...
      if (
        r.series[q[0]].highlightMouseDown &&
        !(
          q[0] == r.plugins.bubbleRenderer.highlightedSeriesIndex &&
          q[1] == r.series[q[0]]._highlightedPoint
        )
  ...
  function h() {
    ...
    this.plugins.bubbleRenderer.highlightLabelCanvas = f(
    ...
    this.eventCanvas._elem.before(
      this.plugins.bubbleRenderer.highlightCanvas.createElement(
        this._gridPadding,
    ...
    this.eventCanvas._elem.before(
      this.plugins.bubbleRenderer.highlightLabelCanvas
    );
