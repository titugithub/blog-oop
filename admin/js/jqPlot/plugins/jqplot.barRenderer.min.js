...
(function (d) {
  ...
  function g(s, o, n, v) {
    ...
    if (this.rendererOptions.waterfall == true) {
      ...
      this.data[this.data.length] =
        t == 1 ? [this.data.length + 1, r] : [r, this.data.length + 1];
      this._data[this._data.length] =
        t == 1 ? [this._data.length + 1, r] : [r, this._data.length + 1];
    }
  ...
  d.jqplot.BarRenderer.prototype.setBarWidth = function () {
    ...
    if (r.name == "xaxis" || r.name == "x2axis") {
      if (this._stack) {
        this.barWidth =
          ((r._offsets.max - r._offsets.min) / m) * n - this.barMargin;
      } else {
        this.barWidth =
          ((r._offsets.max - r._offsets.min) / o -
            this.barPadding * (n - 1) -
            this.barMargin * 2) /
          n;
      }
      ...
      if (this._stack) {
        this.barWidth =
          ((r._offsets.min - r._offsets.max) / m) * n - this.barMargin;
      } else {
        this.barWidth =
          ((r._offsets.min - r._offsets.max) / o -
            this.barPadding * (n - 1) -
            this.barMargin * 2) /
          n;
      }
  ...
  d.jqplot.BarRenderer.prototype.draw = function (D, J, p) {
    ...
    if (this._stack) {
      ...
      this._barNudge =
        (-Math.abs(v / 2 - 0.5) + r) * (this.barWidth + this.barPadding);
    }
    if (M) {
      ...
      if (this.barDirection == "vertical") {
        for (var G = 0; G < J.length; G++) {
          ...
          if (
            (this.fillToZero && this._plotData[G][1] < 0) ||
            (this.waterfall && this._data[G][1] < 0)
          ) {
  ...
  d.jqplot.BarRenderer.prototype.drawShadow = function (y, E, o) {
    ...
    if (this._stack && this.shadow) {
      ...
      if (this._stack) {
        ...
        this._barNudge =
          (-Math.abs(s / 2 - 0.5) + q) * (this.barWidth + this.barPadding);
      }
      if (G) {
        if (this.barDirection == "vertical") {
  ...
  function b(q, p, t, s, r) {
    if (s) {
      ...
      if (
        ...
        !(
          o[0] == r.plugins.barRenderer.highlightedSeriesIndex &&
  ...
  function a(p, o, s, r, q) {
    if (r) {
      ...
      if (
        ...
        !(
          n[0] == q.plugins.barRenderer.highlightedSeriesIndex &&
